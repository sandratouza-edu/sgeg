        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text" style="color:  {{ $degree->color }}"><i class="fas fa-square"></i></span>
                </div>
                <input type="text" id="inputName" class="form-control" name="name" value="{{ $degree->color }}">
            </div>
        </div>
        <div class="form-group">

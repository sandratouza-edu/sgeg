...
Route::resource('/student', UserController::class)->names('user');
...
//CSV import
Route::get('/useractions', [CsvController::class, 'index'])->name('userImport');
...
Route::get('/admin', [App\Http\Controllers\HomeController::class, 'index'])->name('user');

Route::get('/admin/settings', [App\Http\Controllers\HomeController::class, 'index'])->name('user');

...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <x-adminlte-input name="dni" label="DNI" value="{{ $user->dni }}" label-class="text-lightblue">
                <x-slot name="prependSlot">
                    <div class="input-group-text">
        ...
        <div class="form-group">
            ...
            <x-adminlte-select id="degree" name="degree_id" label="{{ __('Degree') }}" label-class="text-lightblue">
                ...
                <x-adminlte-options :options="$options" :selected="$user->degree_id"
        ...
        <div class="form-group">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <label>
                            {!! Form::checkbox('roles[]', $role->id, $user->hasAnyRole($role->id) ?: false, ['class' =>
                            'mr-1']) !!}
                            {{ Str::upper($role->name) }}
                        </label>
                    </div>

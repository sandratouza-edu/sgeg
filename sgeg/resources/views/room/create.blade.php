            ...
            <div class="form-group">
                    ...
                    <div class="card-body">
                        <blockquote class="quote-orange mt-0">
                            <h5>Aviso!</h5>
                            <p>{{ __('Must have a json estructure similar to the next example') }}</p>
                            <p>{{ __('Must define areas, sections rows and cols') }}</p>
                            ...
                            <div class="language-html max-height-300 highlighter-rouge">
                                ...
                                "areas":
                                [{"name": "area1",
                                "sections": [{"cols": 10, "name": "section 1", "rows": "10"}, {"cols": 10, "name":
                                "section 2", "rows": "10"}, {"cols": 10, "name": "section 3", "rows": "10"}, {"cols":
                                10, "name": "section 4", "rows": "10"}],
                                "numsections": "4"},
                                {"name": "area2",
                                "sections": [{"cols": 15, "name": "section 1", "rows": "10"}, {"cols": 15, "name":
                                "section 2", "rows": "10"}],
                                "numsections": "2"}]
                                }
                            </div>
